  ...
  <script>
    ...
    btnUbahs.forEach((btnUbah) => {
      btnUbah.addEventListener('click', () => {
        ...
        const atrNama = btnUbah.getAttribute('namaruang');
        const atrIdRuang = btnUbah.getAttribute('idruang');

        // Elemen modal
        const modalNama = formUbah.querySelector('input[name="namaruang"]');
        const modalIdRuang = formUbah.querySelector('input[name="idruang"]');
