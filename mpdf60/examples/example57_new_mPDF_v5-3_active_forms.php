...
<b>Input Text</b>
<input type="text" size="90" name="inputfield" value=""../../../mpdf60/examples/ title="The title attribute works like a tool-tip" /> 
<br /><br />

<b>Readonly</b>
<input type="text" size="90" name="readonlyfield" value="Read-only field. The value will be exported on submit"../../../mpdf60/examples/ title="The title does not do anything if the field is read-only" readonly="readonly" /> 
<br /><br />

<b>Disabled</b>
<input type="text" size="90" name="disabledfield" value="Disabled field. The value will not be exported on submit"../../../mpdf60/examples/ title="The title does not do anything if the field is disabled." disabled="disabled" /> 
<br /><br />

<b>Required</b>
<input type="text" size="90" name="requiredfield" value=""../../../mpdf60/examples/ title="This field must be entered before you can submit." required="required" /> 
<br /><br />
...
<b>Input Password</b>
<input type="password" size="40" name="password" value="mysecretpassword"../../../mpdf60/examples/ title="This field is set to act as a password field." > 
<br /><br />
...
<b>Textarea</b>
<textarea name="textareafield" spellcheck="true" rows="5" cols="80" wrap="virtual"../../../mpdf60/examples/ title="Textarea tooltip">Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet ipsum id enim tempus dictum. </textarea>
<br /><br />
