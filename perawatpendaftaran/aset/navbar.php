<?php
$nama = namakaryawan($_SESSION['emailPerawatPendaftaran']);
?>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link active" href="monitoringrawatinap.php">Monitorin Rawat Inap</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="pendaftaranrawatinap.php">Pendaftaran Inap</a>
        </li>
        <li class="nav-item">
